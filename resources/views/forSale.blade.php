...
<header class="bg-white shadow-md z-10">
    <div class="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav class="flex-1 tetx-sm text-green-800 mt-10 z-10">
            <ul class="flex justify-center space-x-10 text-lg" style="margin-top:20px;">
                <li><a href="{{ url('/') }}" class="hover:text-green-600">Home</a></li>
                <li><a href="{{ url('/forsale') }}" class="hover:text-green-600">For Sale</a></li>
                <li><a href="{{ url('/forrent') }}" class="hover:text-green-600">Rentals</a></li>
                <li><a href="{{ url('/upcoming') }}" class="hover:text-green-600">Upcoming</a></li>
                <li><a href="{{ url('/aboutus') }}" class="hover:text-green-600">About Us</a></li>
            </ul>
        </nav>
        <div class="flex items-center space-x-6 z-10">
            ...
            <a href="{{ url('/post-ad') }}" class="bg-red-700 text-white px-8 py-3 rounded-lg shadow-md text-lg font-bold z-10">Post AD</a>
        </div>
    </div>
</header>
...
<section class="container mx-auto px-6 py-12">
    <h2 class="text-2xl font-bold text-center mb-8">For Sale</h2>
    <hr class="border-t border-black mb-6">
    
    
    @livewire('for-sale-list')
